...
public class TileEntityNukeCustom extends TileEntity implements ITickable, IGUIProvider {
	...
	public static void registerBombItems() {
		...
		entries.put(new ComparableStack(Ingots.ingot_semtex), new CustomNukeEntry(EnumBombType.TNT, 8F));
		entries.put(new ComparableStack(Ingots.ingot_c4), new CustomNukeEntry(EnumBombType.TNT, 10F));
		...
		//NUKE
		entries.put(new ComparableStack(Nuggies.nugget_u235), new CustomNukeEntry(EnumBombType.NUKE, 1.5F));
		entries.put(new ComparableStack(Billets.billet_u235), new CustomNukeEntry(EnumBombType.NUKE, 10F));
		entries.put(new ComparableStack(Ingots.ingot_u235), new CustomNukeEntry(EnumBombType.NUKE, 15F));
		entries.put(new ComparableStack(Nuggies.nugget_pu239), new CustomNukeEntry(EnumBombType.NUKE, 2.5F));
		entries.put(new ComparableStack(Billets.billet_pu239), new CustomNukeEntry(EnumBombType.NUKE, 17F));
		entries.put(new ComparableStack(Ingots.ingot_pu239), new CustomNukeEntry(EnumBombType.NUKE, 25F));
		entries.put(new ComparableStack(Nuggies.nugget_neptunium), new CustomNukeEntry(EnumBombType.NUKE, 3.0F));
		entries.put(new ComparableStack(Billets.billet_neptunium), new CustomNukeEntry(EnumBombType.NUKE, 20.0F));
		entries.put(new ComparableStack(Ingots.ingot_neptunium), new CustomNukeEntry(EnumBombType.NUKE, 30F));
		entries.put(new ComparableStack(Powders.powder_neptunium), new CustomNukeEntry(EnumBombType.NUKE, 30F));
		...
		entries.put(new ComparableStack(Nuggies.nugget_uranium), new CustomNukeEntry(EnumBombType.NUKE, 1.005F, EnumEntryType.MULT));
		entries.put(new ComparableStack(Ingots.ingot_uranium), new CustomNukeEntry(EnumBombType.NUKE, 1.05F, EnumEntryType.MULT));
		entries.put(new ComparableStack(Powders.powder_uranium), new CustomNukeEntry(EnumBombType.NUKE, 1.05F, EnumEntryType.MULT));
		entries.put(new ComparableStack(Nuggies.nugget_plutonium), new CustomNukeEntry(EnumBombType.NUKE, 1.15F, EnumEntryType.MULT));
		entries.put(new ComparableStack(Powders.powder_plutonium), new CustomNukeEntry(EnumBombType.NUKE, 1.15F, EnumEntryType.MULT));
		entries.put(new ComparableStack(Ingots.ingot_plutonium), new CustomNukeEntry(EnumBombType.NUKE, 1.15F, EnumEntryType.MULT));
		entries.put(new ComparableStack(Nuggies.nugget_u238), new CustomNukeEntry(EnumBombType.NUKE, 1.01F, EnumEntryType.MULT));
		entries.put(new ComparableStack(Ingots.ingot_u238), new CustomNukeEntry(EnumBombType.NUKE, 1.1F, EnumEntryType.MULT));
		entries.put(new ComparableStack(Nuggies.nugget_pu238), new CustomNukeEntry(EnumBombType.NUKE, 1.015F, EnumEntryType.MULT));
		entries.put(new ComparableStack(Ingots.ingot_pu238), new CustomNukeEntry(EnumBombType.NUKE, 1.15F, EnumEntryType.MULT));
		...
		entries.put(new ComparableStack(Ingots.lithium), new CustomNukeEntry(EnumBombType.HYDRO, 20F));
		...
		//ANTIMATTER
		entries.put(new ComparableStack(ItemCell.getFullCell(Fluids.AMAT)), new CustomNukeEntry(EnumBombType.BALE, 1.05F, EnumEntryType.MULT));
		...
		//SALTED
		entries.put(new ComparableStack(Ingots.ingot_tungsten), new CustomNukeEntry(EnumBombType.DIRTY, 0.1F));
		entries.put(new ComparableStack(Powders.powder_tungsten), new CustomNukeEntry(EnumBombType.DIRTY, 0.1F));
		...
		entries.put(new ComparableStack(Nuggies.nugget_cobalt), new CustomNukeEntry(EnumBombType.DIRTY, 0.1F));
		entries.put(new ComparableStack(Ingots.ingot_cobalt), new CustomNukeEntry(EnumBombType.DIRTY, 1F));
		entries.put(new ComparableStack(Powders.powder_cobalt_tiny), new CustomNukeEntry(EnumBombType.DIRTY, 0.1F));
		entries.put(new ComparableStack(Powders.powder_cobalt), new CustomNukeEntry(EnumBombType.DIRTY, 1F));
		entries.put(new ComparableStack(ModBlocks.block_cobalt), new CustomNukeEntry(EnumBombType.DIRTY, 10F));

		entries.put(new ComparableStack(Nuggies.nugget_co60), new CustomNukeEntry(EnumBombType.DIRTY, 0.4F));
		entries.put(new ComparableStack(Ingots.ingot_co60), new CustomNukeEntry(EnumBombType.DIRTY, 4F));
		entries.put(new ComparableStack(Powders.powder_co60_tiny), new CustomNukeEntry(EnumBombType.DIRTY, 0.4F));
		entries.put(new ComparableStack(Powders.powder_co60), new CustomNukeEntry(EnumBombType.DIRTY, 4F));
		entries.put(new ComparableStack(Billets.billet_co60), new CustomNukeEntry(EnumBombType.DIRTY, 3F));

		entries.put(new ComparableStack(Nuggies.nugget_strontium), new CustomNukeEntry(EnumBombType.DIRTY, 0.2F));
		entries.put(new ComparableStack(Ingots.ingot_strontium), new CustomNukeEntry(EnumBombType.DIRTY, 2F));
		entries.put(new ComparableStack(Powders.powder_strontium), new CustomNukeEntry(EnumBombType.DIRTY, 2F));

		entries.put(new ComparableStack(Nuggies.nugget_sr90), new CustomNukeEntry(EnumBombType.DIRTY, 0.6F));
		entries.put(new ComparableStack(Ingots.ingot_sr90), new CustomNukeEntry(EnumBombType.DIRTY, 6F));
		entries.put(new ComparableStack(Powders.powder_sr90_tiny), new CustomNukeEntry(EnumBombType.DIRTY, 0.6F));
		entries.put(new ComparableStack(Powders.powder_sr90), new CustomNukeEntry(EnumBombType.DIRTY, 6F));
		entries.put(new ComparableStack(Billets.billet_sr90), new CustomNukeEntry(EnumBombType.DIRTY, 4F));

		entries.put(new ComparableStack(Ingots.ingot_iodine), new CustomNukeEntry(EnumBombType.DIRTY, 12F));
		entries.put(new ComparableStack(Powders.powder_iodine_tiny), new CustomNukeEntry(EnumBombType.DIRTY, 1.2F));
		entries.put(new ComparableStack(Powders.powder_iodine), new CustomNukeEntry(EnumBombType.DIRTY, 12F));
		entries.put(new ComparableStack(Ingots.ingot_i131), new CustomNukeEntry(EnumBombType.DIRTY, 24F));
		entries.put(new ComparableStack(Powders.powder_i131_tiny), new CustomNukeEntry(EnumBombType.DIRTY, 2.4F));
		entries.put(new ComparableStack(Powders.powder_i131), new CustomNukeEntry(EnumBombType.DIRTY, 24F));
		
		entries.put(new ComparableStack(ModItems.custom_dirty), new CustomNukeEntry(EnumBombType.DIRTY, 10F));

		entries.put(new ComparableStack(Ingots.ingot_pu240), new CustomNukeEntry(EnumBombType.DIRTY, 1.05F, EnumEntryType.MULT));
		entries.put(new ComparableStack(Nuggies.nugget_pu240), new CustomNukeEntry(EnumBombType.DIRTY, 1.005F, EnumEntryType.MULT));
		entries.put(new ComparableStack(Billets.billet_pu240), new CustomNukeEntry(EnumBombType.DIRTY, 1.03F, EnumEntryType.MULT));
		entries.put(new ComparableStack(ModBlocks.block_pu240), new CustomNukeEntry(EnumBombType.DIRTY, 1.5F, EnumEntryType.MULT));

		entries.put(new ComparableStack(Billets.billet_nuclear_waste), new CustomNukeEntry(EnumBombType.DIRTY, 1.02F, EnumEntryType.MULT));
		...
		//ANTISCHRABIDIUM
		entries.put(new ComparableStack(Ingots.ingot_schrabidium), new CustomNukeEntry(EnumBombType.SCHRAB, 5F));
		entries.put(new ComparableStack(ModBlocks.block_schrabidium), new CustomNukeEntry(EnumBombType.SCHRAB, 50F));
		entries.put(new ComparableStack(Billets.billet_schrabidium), new CustomNukeEntry(EnumBombType.SCHRAB, 3F));
		entries.put(new ComparableStack(Nuggies.nugget_schrabidium), new CustomNukeEntry(EnumBombType.SCHRAB, 0.5F));
		entries.put(new ComparableStack(Powders.powder_schrabidium), new CustomNukeEntry(EnumBombType.SCHRAB, 5F));
		...
		entries.put(new ComparableStack(Nuggies.nugget_solinium), new CustomNukeEntry(EnumBombType.SOL, 0.5F));
		entries.put(new ComparableStack(Ingots.ingot_solinium), new CustomNukeEntry(EnumBombType.SOL, 5F));
		entries.put(new ComparableStack(Billets.billet_solinium), new CustomNukeEntry(EnumBombType.SOL, 3F));
		entries.put(new ComparableStack(ModBlocks.block_solinium), new CustomNukeEntry(EnumBombType.SOL, 50F));

		entries.put(new ComparableStack(Nuggies.nugget_unobtainium), new CustomNukeEntry(EnumBombType.SOL, 1.01F, EnumEntryType.MULT));
		entries.put(new ComparableStack(Ingots.ingot_unobtainium), new CustomNukeEntry(EnumBombType.SOL, 1.1F, EnumEntryType.MULT));
		entries.put(new ComparableStack(Powders.powder_unobtainium), new CustomNukeEntry(EnumBombType.SOL, 1.1F, EnumEntryType.MULT));
		...
		//ANTI-MASS
		entries.put(new ComparableStack(Nuggies.nugget_euphemium), new CustomNukeEntry(EnumBombType.EUPH, 0.1F));
		entries.put(new ComparableStack(Ingots.ingot_euphemium), new CustomNukeEntry(EnumBombType.EUPH, 1F));
		entries.put(new ComparableStack(ModItems.custom_euph), new CustomNukeEntry(EnumBombType.EUPH, 2F));
		entries.put(new ComparableStack(Powders.powder_euphemium), new CustomNukeEntry(EnumBombType.EUPH, 1F));
