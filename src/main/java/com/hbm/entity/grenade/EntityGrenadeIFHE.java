...
@AutoRegister(name = "entity_grenade_if_he")
public class EntityGrenadeIFHE extends EntityGrenadeBouncyBase {
    ...
    public void explode() {
        ...
        if (!this.world.isRemote)
        {
    		...
    		ExplosionLarge.jolt(world, thrower, posX, posY, posZ, 7.5, 300, 0.25);
    		ExplosionLarge.explode(world, thrower, posX, posY, posZ, 7, true, true, true);
        }
    }

	@Override
	protected int getMaxTimer() {
		return ItemGrenade.getFuseTicks(Armory.grenade_if_he);
	}
