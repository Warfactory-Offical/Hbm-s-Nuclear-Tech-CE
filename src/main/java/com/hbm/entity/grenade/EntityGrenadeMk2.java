...
@AutoRegister(name = "entity_grenade_mk2")
public class EntityGrenadeMk2 extends EntityGrenadeBouncyBase {
	...
	public void explode() {
		...
		if (!this.world.isRemote) {
			this.setDead();
			ExplosionLarge.explode(world, thrower, posX, posY, posZ, 7.5F, true, false, false);
		}
	}

	@Override
	protected int getMaxTimer() {
		return ItemGrenade.getFuseTicks(Armory.grenade_mk2);
	}
