...
public abstract class EntityMissileTier1 extends EntityMissileBaseNT {
	...
	@AutoRegister(name = "entity_missile_generic", trackingRange = 1000)
	...
	@AutoRegister(name = "entity_missile_decoy", trackingRange = 1000)
	...
	@AutoRegister(name = "entity_missile_incendiary", trackingRange = 1000)
	...
	@AutoRegister(name = "entity_missile_cluster", trackingRange = 1000)
	...
	@AutoRegister(name = "entity_missile_bunker_buster", trackingRange = 1000)
