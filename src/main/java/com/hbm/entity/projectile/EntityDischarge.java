...
@AutoRegister(name = "entity_discharge", trackingRange = 1000)
public class EntityDischarge extends Entity implements IProjectile {
                ...
                if (RayTraceResult.entityHit != null)
                {
                    ...
                    if (RayTraceResult.entityHit.attackEntityFrom(damagesource, k))
                    {
                        ...
                        if (!(RayTraceResult.entityHit instanceof EntityEnderman))
                        {
                            ...
                            {
                            	RayTraceResult.entityHit.attackEntityFrom(damagesource, 24 + rand.nextInt(11));
                            }
                        }
                    }
                }
	...
	public void onCollideWithPlayer(EntityPlayer p_70100_1_)
    {
        if (!this.world.isRemote && this.inGround && this.arrowShake <= 0)
        {
            ...
            if (this.canBePickedUp == 1 && !p_70100_1_.inventory.addItemStackToInventory(new ItemStack(DummyTexs.nothing, 1))) //ammo_fucking_rocket
            {
                flag = false;
            }
