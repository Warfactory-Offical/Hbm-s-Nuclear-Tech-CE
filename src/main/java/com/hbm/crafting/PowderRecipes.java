...
public class PowderRecipes {
    public static void register() {
        ...
        CraftingManager.addShapelessAuto(new ItemStack(Ingots.ingot_c4, 4), Fluids.UNSATURATEDS.getDict(1000), KNO.dust(), KEY_TOOL_CHEMISTRYSET );
        CraftingManager.addShapelessAuto(new ItemStack(Powders.powder_semtex_mix, 3), ModItems.solid_fuel, ModItems.cordite, KNO.dust() );
        CraftingManager.addShapelessAuto(new ItemStack(Powders.powder_semtex_mix, 1), ModItems.solid_fuel, ModItems.ballistite, KNO.dust() );
        ...
        //Other
        CraftingManager.addShapelessAuto(new ItemStack(Ingots.ingot_steel_dusted, 1), STEEL.ingot(), COAL.dust() );
        CraftingManager.addShapelessAuto(new ItemStack(Powders.powder_bakelite, 2), Fluids.AROMATICS.getDict(1000), Fluids.PETROLEUM.getDict(1000), KEY_TOOL_CHEMISTRYSET );
        ...
        //Blends
        CraftingManager.addShapelessAuto(new ItemStack(Powders.powder_power, 3), "dustGlowstone", DIAMOND.dust(), MAGTUNG.dust() );
        CraftingManager.addShapelessAuto(new ItemStack(Powders.powder_nitan_mix, 6), NP237.dust(), I.dust(), TH232.dust(), AT.dust(), ND.dust(), CS.dust() );
        CraftingManager.addShapelessAuto(new ItemStack(Powders.powder_nitan_mix, 6), SR.dust(), CO.dust(), BR.dust(), TS.dust(), NB.dust(), CE.dust() );
        CraftingManager.addShapelessAuto(new ItemStack(Powders.powder_spark_mix, 3), DESH.dust(), EUPH.dust(), Powders.powder_power );
        CraftingManager.addShapelessAuto(new ItemStack(Powders.powder_meteorite, 4), IRON.dust(), CU.dust(), LI.dust(), NETHERQUARTZ.dust() );
        CraftingManager.addShapelessAuto(new ItemStack(Powders.powder_thermite, 4), IRON.dust(), IRON.dust(), IRON.dust(), AL.dust() );

        CraftingManager.addShapelessAuto(new ItemStack(Powders.powder_desh_mix, 1), B.dustTiny(), B.dustTiny(), LA.dustTiny(), LA.dustTiny(), CE.dustTiny(), CO.dustTiny(), LI.dustTiny(), ND.dustTiny(), NB.dustTiny() );
        CraftingManager.addShapelessAuto(new ItemStack(Powders.powder_desh_mix, 9), B.dust(), B.dust(), LA.dust(), LA.dust(), CE.dust(), CO.dust(), LI.dust(), ND.dust(), NB.dust() );
        CraftingManager.addShapelessAuto(new ItemStack(Powders.powder_desh_ready, 1), Powders.powder_desh_mix, Nuggies.ingot_mercury, Nuggies.ingot_mercury, COAL.dust() );
        ...
        CraftingManager.addShapelessAuto(new ItemStack(Powders.powder_flux, 1), new ItemStack(Items.COAL, 1, 1), KEY_SAND );
        CraftingManager.addShapelessAuto(new ItemStack(Powders.powder_flux, 2), COAL.dust(), KEY_SAND );
        CraftingManager.addShapelessAuto(new ItemStack(Powders.powder_flux, 4), F.dust(), KEY_SAND );
        CraftingManager.addShapelessAuto(new ItemStack(Powders.powder_flux, 8), PB.dust(), S.dust(), KEY_SAND );
        CraftingManager.addShapelessAuto(new ItemStack(Powders.powder_flux, 12), LIMESTONE.dust(), KEY_SAND );
        CraftingManager.addShapelessAuto(new ItemStack(Powders.powder_flux, 12), CA.dust(), KEY_SAND );
        CraftingManager.addShapelessAuto(new ItemStack(Powders.powder_flux, 16), BORAX.dust(), KEY_SAND );

        CraftingManager.addShapelessAuto(new ItemStack(Powders.powder_fertilizer, 4), CA.dust(), P_RED.dust(), KNO.dust(), S.dust() );
        CraftingManager.addShapelessAuto(new ItemStack(Powders.powder_fertilizer, 4), ANY_ASH.any(), P_RED.dust(), KNO.dust(), S.dust() );

        if(GeneralConfig.enableLBSM && GeneralConfig.enableLBSMSimpleCrafting) {
            CraftingManager.addShapelessAuto(new ItemStack(Powders.powder_advanced_alloy, 4), REDSTONE.dust(), IRON.dust(), COAL.dust(), CU.dust() );
            CraftingManager.addShapelessAuto(new ItemStack(Powders.powder_advanced_alloy, 4), IRON.dust(), COAL.dust(), MINGRADE.dust(), MINGRADE.dust() );
            CraftingManager.addShapelessAuto(new ItemStack(Powders.powder_advanced_alloy, 4), REDSTONE.dust(), CU.dust(), STEEL.dust(), STEEL.dust() );
            CraftingManager.addShapelessAuto(new ItemStack(Powders.powder_advanced_alloy, 2), MINGRADE.dust(), STEEL.dust() );
            CraftingManager.addShapelessAuto(new ItemStack(Powders.powder_red_copper, 2), REDSTONE.dust(), CU.dust() );
            CraftingManager.addShapelessAuto(new ItemStack(Powders.powder_dura_steel, 2), STEEL.dust(), W.dust() );
            CraftingManager.addShapelessAuto(new ItemStack(Powders.powder_dura_steel, 2), STEEL.dust(), CO.dust() );
            CraftingManager.addShapelessAuto(new ItemStack(Powders.powder_dura_steel, 4), IRON.dust(), COAL.dust(), W.dust(), W.dust() );
            CraftingManager.addShapelessAuto(new ItemStack(Powders.powder_dura_steel, 4), IRON.dust(), COAL.dust(), CO.dust(), CO.dust() );
            CraftingManager.addRecipeAuto(new ItemStack(Ingots.ingot_firebrick, 4), "BN", "NB", 'B', Items.BRICK, 'N', Items.NETHERBRICK );
        }
