...
public class ItemBDCL extends ItemBakedBase {
    ...
    public void onUsingTick(ItemStack stack, EntityLivingBase entity, int count) {
        ...
        if(count % 5 == 0 && count >= 10) {
            player.world.playSound(null, player.posX, player.posY, player.posZ, HBMSoundEvents.gulp, SoundCategory.PLAYERS, 1.0F, 1.0F);
        }
        ...
        if(count == 1) {
            ...
            player.playSound(HBMSoundEvents.groan, 1.0F, 1.0F);
            return;
        }
