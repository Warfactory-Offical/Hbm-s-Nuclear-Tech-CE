...
public class XFactoryTool {
    ...
    @SuppressWarnings("incomplete-switch") public static BiFunction<ItemStack, HbmAnimationsSedna.AnimType, BusAnimationSedna> LAMBDA_CT_ANIMS = (stack, type) -> switch (type) {
