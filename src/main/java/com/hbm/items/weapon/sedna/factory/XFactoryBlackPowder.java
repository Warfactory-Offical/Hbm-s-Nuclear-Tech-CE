...
public class XFactoryBlackPowder {
    ...
    public static void init() {
        ...
        ModItems.gun_pepperbox = new ItemGunBaseNT(ItemGunBaseNT.WeaponQuality.A_SIDE, "gun_pepperbox", new GunConfig()
                ...
                .rec(new Receiver(0)
                        .dmg(5F).delay(27).reload(67).jam(58).sound(HBMSoundEvents.fireBlackPowder, 1.0F, 1.0F)
    ...
    @SuppressWarnings("incomplete-switch") public static BiFunction<ItemStack, HbmAnimationsSedna.AnimType, BusAnimationSedna> LAMBDA_PEPPERBOX_ANIMS = (stack, type) -> switch (type) {
