...
public class ModItems {
	...
	public static final Item rod = new ItemBreedingRod("rod").setContainerItem(RetroRods.rod_empty).setCreativeTab(MainRegistry.controlTab);
	public static final Item rod_dual = new ItemBreedingRod("rod_dual").setContainerItem(RetroRods.rod_dual_empty).setCreativeTab(MainRegistry.controlTab);
	public static final Item rod_quad = new ItemBreedingRod("rod_quad").setContainerItem(RetroRods.rod_quad_empty).setCreativeTab(MainRegistry.controlTab);
	//RTG
	...
	public static final ToolMaterial matDwarf = EnumHelper.addToolMaterial("HBM_DWARVEN", 2, 0, 4F, 0.0F, 10).setRepairItem(new ItemStack(Ingots.ingot_copper));
	...
	public static class BlockItems {
		...
		//public static final Item door_fuckoff = new ItemModDoor("door_fuckoff").setCreativeTab(null); LCE Pink Door
	}
	...
	public static class DummyTexs {
		//Dummy texture items; Note: Use EffectItem to autohide them from JEI
		public static final Item achievement_icon = new ItemEnumMulti("achievement_icon", EnumAchievementType.class, true, true).setCreativeTab(null);
		...
		public static final Item nothing = new EffectItem("nothing").setCreativeTab(null); // just why??
	}
