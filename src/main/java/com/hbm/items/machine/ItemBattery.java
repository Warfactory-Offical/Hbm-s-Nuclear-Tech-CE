...
public class ItemBattery extends Item implements IBatteryItem {
    ...
    public void addInformation(ItemStack stack, World worldIn, List<String> list, ITooltipFlag flagIn) {
        if (stack.getItem() == Batteries.battery_creative) return;
    ...
    public long getCharge(ItemStack stack) {
        if (stack.getItem() == Batteries.battery_creative) return Long.MAX_VALUE;
        if (stack.getItem() instanceof ItemBattery) {
            if (stack.hasTagCompound()) {
    ...
    public boolean showDurabilityBar(ItemStack stack) {
        return stack.getItem() != Batteries.battery_creative;
    }
