...
public class ShredderRecipes extends SerializableRecipe {
    ...
    public void registerDefaults() {
        ...
        ShredderRecipes.setRecipe(OreDictManager.DictFrame.fromOne(ModBlocks.stone_resource, BlockEnums.EnumStoneType.LIMESTONE), new ItemStack(Powders.powder_limestone, 4));
        ...
        ShredderRecipes.setRecipe(ModItems.coal_infernal, new ItemStack(Powders.powder_coal, 2));
        ...
        ShredderRecipes.setRecipe(Foods.can_empty, new ItemStack(Powders.powder_aluminium, 2));
        ShredderRecipes.setRecipe(OreDictManager.DictFrame.fromOne(ModItems.chunk_ore, ItemEnums.EnumChunkType.RARE), new ItemStack(Powders.powder_desh_mix));
        ...
        ShredderRecipes.setRecipe(ModBlocks.block_bakelite, new ItemStack(Powders.powder_bakelite, 9));
        ShredderRecipes.setRecipe(Ingots.ingot_bakelite, new ItemStack(Powders.powder_bakelite));
        ...
        for (ItemStack log : logs)
            ShredderRecipes.setRecipe(log, new ItemStack(Powders.powder_sawdust, 4));
        for (ItemStack plank : planks)
            ShredderRecipes.setRecipe(plank, new ItemStack(Powders.powder_sawdust, 1));
        ...
        ShredderRecipes.setRecipe(Crystals.crystal_lapis, new ItemStack(Powders.powder_lapis, 8));
        ...
        ShredderRecipes.setRecipe(Crystals.crystal_sulfur, new ItemStack(Powders.sulfur, 8));
        ShredderRecipes.setRecipe(Crystals.crystal_niter, new ItemStack(Powders.niter, 8));
        ...
        /* Misc recycling */
        ShredderRecipes.setRecipe(ModBlocks.steel_poles, new ItemStack(Powders.powder_steel_tiny, 2));
        ShredderRecipes.setRecipe(ModBlocks.steel_roof, new ItemStack(Powders.powder_steel_tiny, 9));
        ShredderRecipes.setRecipe(ModBlocks.steel_wall, new ItemStack(Powders.powder_steel_tiny, 9));
        ShredderRecipes.setRecipe(ModBlocks.steel_corner, new ItemStack(Powders.powder_steel_tiny, 18));
        ShredderRecipes.setRecipe(ModBlocks.steel_beam, new ItemStack(Powders.powder_steel_tiny, 3));
        ShredderRecipes.setRecipe(new ItemStack(ModBlocks.steel_scaffold, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Powders.powder_steel_tiny, 4));
        ...
        ShredderRecipes.setRecipe(ModItems.debris_shrapnel, new ItemStack(Powders.powder_steel_tiny, 5));
        ShredderRecipes.setRecipe(ModItems.debris_exchanger, new ItemStack(Powders.powder_steel, 3));
        ShredderRecipes.setRecipe(ModItems.debris_element, new ItemStack(ModItems.scrap_nuclear, 4));
        ShredderRecipes.setRecipe(ModItems.debris_metal, new ItemStack(Powders.powder_steel_tiny, 3));
        ShredderRecipes.setRecipe(ModItems.debris_graphite, new ItemStack(Powders.powder_coal, 1));
