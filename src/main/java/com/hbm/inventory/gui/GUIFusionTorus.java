...
public class GUIFusionTorus extends GuiInfoContainer {
    ...
    public GUIFusionTorus(InventoryPlayer invPlayer, TileEntityFusionTorus torus) {
        super(new ContainerFusionTorus(invPlayer, torus.getCheckedInventory()));
        this.torus = torus;
    ...
    protected void drawGuiContainerBackgroundLayer(float interp, int x, int y) {
        ...
        double gauge = BobMathUtil.sps((Minecraft.getMinecraft().world.getTotalWorldTime() + interp) * 0.25) / 2 + 0.5D;
