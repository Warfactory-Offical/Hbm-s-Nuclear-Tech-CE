...
public class GUIReactorResearch extends GuiInfoContainer {
    ...
    public void initGui() {
        ...
        this.field = new GuiTextField(0, this.fontRenderer, guiLeft + 8, guiTop + 99, 33, 16);
    ...
    public void drawScreen(int mouseX, int mouseY, float f) {
        ...
        //Th3_Sl1ze: remind me to translate this. MEIN GOTT WHO DOES THE FUCK WRITE PLAIN STRINGS INSTEAD OF TRANSLATION KEYS
    ...
    protected void drawGuiContainerForegroundLayer(int i, int j) {
        ...
        this.fontRenderer.drawString(labels[0], 6, 13, 15066597);
        this.fontRenderer.drawString(labels[1], 6, 51, 15066597);
        this.fontRenderer.drawString(labels[2], 6, 89, 15066597);
    }
    ...
    protected void drawGuiContainerBackgroundLayer(float p_146976_1_, int p_146976_2_, int p_146976_3_) {
        ...
        if(NumberUtils.isDigits(field.getText())) {
            int level = (int) MathHelper.clamp(Double.parseDouble(field.getText()), 0, 100);
            field.setText(level + "");
