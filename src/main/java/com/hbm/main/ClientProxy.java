...
//        ClientRegistry.bindTileEntitySpecialRenderer(TileEntityMachineAssembler.class, new RenderAssembler());
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityGrenadeGeneric.class, (RenderManager man) -> {
            return new RenderSnowball<EntityGrenadeGeneric>(man, Armory.grenade_generic, Minecraft.getMinecraft().getRenderItem());
        });
        ...
        registerGrenadeRenderer(EntityGrenadeImpactGeneric.class, Armory.grenade_kyiv);
    ...
    public void registerMissileItems(IRegistry<ModelResourceLocation, IBakedModel> reg) {
        ...
        // GUNS
        registerItemRenderer(Armory.gun_light_revolver, new ItemRenderAtlas(ResourceManager.bio_revolver_tex), reg);
        registerItemRenderer(Armory.gun_light_revolver_atlas, new ItemRenderAtlas(ResourceManager.bio_revolver_atlas_tex), reg);
        registerItemRenderer(Armory.gun_double_barrel, new ItemRenderDoubleBarrel(ResourceManager.double_barrel_tex), reg);
        registerItemRenderer(Armory.gun_double_barrel_sacred_dragon, new ItemRenderDoubleBarrel(ResourceManager.double_barrel_sacred_dragon_tex), reg);
        registerItemRenderer(Armory.gun_flamer, new ItemRenderFlamer(ResourceManager.flamethrower_tex), reg);
        registerItemRenderer(Armory.gun_flamer_topaz, new ItemRenderFlamer(ResourceManager.flamethrower_topaz_tex), reg);
        registerItemRenderer(Armory.gun_flamer_daybreaker, new ItemRenderFlamer(ResourceManager.flamethrower_daybreaker_tex), reg);
        registerItemRenderer(Armory.gun_heavy_revolver, new ItemRenderHeavyRevolver(ResourceManager.heavy_revolver_tex), reg);
        registerItemRenderer(Armory.gun_heavy_revolver_lilmac, new ItemRenderHeavyRevolver(ResourceManager.lilmac_tex), reg);
        registerItemRenderer(Armory.gun_heavy_revolver_protege, new ItemRenderHeavyRevolver(ResourceManager.heavy_revolver_protege_tex), reg);
        registerItemRenderer(Armory.gun_maresleg, new ItemRenderMaresleg(ResourceManager.maresleg_tex), reg);
        registerItemRenderer(Armory.gun_maresleg_broken, new ItemRenderMaresleg(ResourceManager.maresleg_broken_tex), reg);
        registerItemRenderer(Armory.gun_minigun, new ItemRenderMinigun(ResourceManager.minigun_tex), reg);
        registerItemRenderer(Armory.gun_minigun_lacunae, new ItemRenderMinigun(ResourceManager.minigun_lacunae_tex), reg);
        registerItemRenderer(Armory.gun_autoshotgun, new ItemRenderShredder(ResourceManager.shredder_tex), reg);
        registerItemRenderer(Armory.gun_autoshotgun_shredder, new ItemRenderShredder(ResourceManager.shredder_orig_tex), reg);
        registerItemRenderer(Armory.gun_amat, new ItemRenderAmat(ResourceManager.amat_tex), reg);
        registerItemRenderer(Armory.gun_amat_penance, new ItemRenderAmat(ResourceManager.amat_penance_tex), reg);
        registerItemRenderer(Armory.gun_amat_subtlety, new ItemRenderAmat(ResourceManager.amat_subtlety_tex), reg);
        registerItemRenderer(Armory.gun_g3, new ItemRenderG3(ResourceManager.g3_tex), reg);
        registerItemRenderer(Armory.gun_g3_zebra, new ItemRenderG3(ResourceManager.g3_zebra_tex), reg);
        registerItemRenderer(Armory.gun_henry, new ItemRenderHenry(ResourceManager.henry_tex), reg);
        registerItemRenderer(Armory.gun_henry_lincoln, new ItemRenderHenry(ResourceManager.henry_lincoln_tex), reg);
        registerItemRenderer(Armory.gun_laser_pistol, new ItemRenderLaserPistol(ResourceManager.laser_pistol_tex), reg);
        registerItemRenderer(Armory.gun_laser_pistol_pew_pew, new ItemRenderLaserPistol(ResourceManager.laser_pistol_pew_pew_tex), reg);
        registerItemRenderer(Armory.gun_laser_pistol_morning_glory, new ItemRenderLaserPistol(ResourceManager.laser_pistol_morning_glory_tex), reg);
        registerItemRenderer(Armory.gun_autoshotgun_sexy, new ItemRenderSexy(ResourceManager.sexy_tex), reg);
        registerItemRenderer(Armory.gun_autoshotgun_heretic, new ItemRenderSexy(ResourceManager.heretic_tex), reg);
        //
