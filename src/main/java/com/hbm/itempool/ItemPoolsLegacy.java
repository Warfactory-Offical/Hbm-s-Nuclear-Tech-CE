    ...
    public static void init() {
        ...
        new ItemPool(POOL_GENERIC) {{
            this.pool = new WeightedRandomChestContentFrom1710[] {
                    ...
                    weighted(Foods.twinkie, 0, 1, 3, 6),
                    weighted(Items.IRON_INGOT, 0, 2, 6, 10),
                    weighted(Ingots.ingot_steel, 0, 2, 5, 7),
                    weighted(Ingots.ingot_beryllium, 0, 1, 2, 4),
                    weighted(Ingots.ingot_titanium, 0, 1, 1, 3),
                    weighted(ModItems.circuit, ItemEnums.EnumCircuitType.VACUUM_TUBE.ordinal(), 1, 1, 5),
                    weighted(Armory.gun_light_revolver, 0, 1, 1, 3),
                    weighted(Armory.ammo_standard, GunFactory.EnumAmmo.M357_SP.ordinal(), 2, 6, 4),
                    weighted(Armory.ammo_standard, GunFactory.EnumAmmo.G12_BP.ordinal(), 3, 6, 3),
                    weighted(Armory.ammo_standard, GunFactory.EnumAmmo.G26_FLARE_SUPPLY.ordinal(), 1, 1, 1),
                    weighted(ModItems.gun_kit_1, 0, 1, 3, 4),
                    weighted(Armory.gun_maresleg, 0, 1, 1, 1),
                    ...
                    weighted(Batteries.battery_generic, 0, 1, 1, 4),
                    weighted(Batteries.battery_advanced, 0, 1, 1, 2),
                    weighted(ModItems.scrap, 0, 1, 3, 10),
                    weighted(ModItems.dust, 0, 2, 4, 9),
                    weighted(Foods.bottle_opener, 0, 1, 1, 2),
                    weighted(Foods.bottle_nuka, 0, 1, 3, 4),
                    weighted(Foods.bottle_cherry, 0, 1, 1, 2),
                    weighted(ModItems.stealth_boy, 0, 1, 1, 1),
                    weighted(Foods.cap_nuka, 0, 1, 15, 7),
        ...
        new ItemPool(POOL_ANTENNA) {{
            this.pool = new WeightedRandomChestContentFrom1710[] {
                    weighted(Foods.twinkie, 0, 1, 3, 4),
                    weighted(Ingots.ingot_steel, 0, 1, 2, 7),
                    weighted(Ingots.ingot_red_copper, 0, 1, 1, 4),
                    weighted(Ingots.ingot_titanium, 0, 1, 3, 5),
                    ...
                    weighted(Batteries.battery_generic, 0, 1, 1, 4),
                    weighted(Batteries.battery_advanced, 0, 1, 1, 3),
        ...
        new ItemPool(POOL_EXPENSIVE) {{
            this.pool = new WeightedRandomChestContentFrom1710[] {
                    ...
                    weighted(Armory.gun_panzerschreck, 0, 1, 1, 4),
                    weighted(Armory.ammo_standard, GunFactory.EnumAmmo.ROCKET_HE.ordinal(), 1, 4, 5),
                    weighted(Armory.ammo_standard, GunFactory.EnumAmmo.G26_FLARE_SUPPLY.ordinal(), 1, 1, 5),
                    weighted(Armory.ammo_standard, GunFactory.EnumAmmo.G26_FLARE_WEAPON.ordinal(), 1, 1, 3),
                    weighted(Armory.grenade_nuclear, 0, 1, 1, 2),
                    weighted(Armory.grenade_smart, 0, 1, 3, 3),
                    weighted(Armory.grenade_mirv, 0, 1, 1, 2),
                    weighted(ModItems.stealth_boy, 0, 1, 1, 2),
                    weighted(Batteries.battery_advanced, 0, 1, 1, 3),
                    weighted(Batteries.battery_advanced_cell, 0, 1, 1, 2),
                    weighted(Batteries.battery_schrabidium, 0, 1, 1, 1),
                    weighted(ModItems.syringe_awesome, 0, 1, 1, 1),
                    weighted(ModItems.fusion_core, 0, 1, 1, 4),
                    weighted(Foods.bottle_nuka, 0, 1, 3, 6),
                    weighted(Foods.bottle_quantum, 0, 1, 1, 3),
        ...
        new ItemPool(POOL_NUKE_TRASH) {{
            this.pool = new WeightedRandomChestContentFrom1710[] {
                    weighted(Nuggies.nugget_u238, 0, 3, 12, 5),
                    weighted(Nuggies.nugget_pu240, 0, 3, 8, 5),
                    weighted(Nuggies.nugget_neptunium, 0, 1, 4, 3),
                    ...
                    weighted(Foods.bottle_quantum, 0, 1, 1, 1),
                    weighted(ModItems.gas_mask_m65, 60, 1, 1, 5),
        ...
        new ItemPool(POOL_NUKE_MISC) {{
            this.pool = new WeightedRandomChestContentFrom1710[] {
                    weighted(Nuggies.nugget_u235, 0, 3, 12, 5),
                    weighted(Nuggies.nugget_pu238, 0, 3, 12, 5),
                    weighted(Nuggies.nugget_ra226, 0, 3, 6, 5),
                    ...
                    weighted(Powders.powder_thorium, 0, 1, 1, 1),
                    weighted(Powders.powder_neptunium, 0, 1, 1, 1),
                    weighted(Powders.powder_strontium, 0, 1, 1, 1),
        ...
        new ItemPool(POOL_VERTIBIRD) {{
            this.pool = new WeightedRandomChestContentFrom1710[] {
                    weighted(ArmorSets.t51_helmet, 0, 1, 1, 15),
                    weighted(ArmorSets.t51_plate, 0, 1, 1, 15),
                    weighted(ArmorSets.t51_legs, 0, 1, 1, 15),
                    weighted(ArmorSets.t51_boots, 0, 1, 1, 15),
                    weighted(ModItems.t45_kit, 0, 1, 1, 3),
                    weighted(ModItems.fusion_core, 0, 1, 1, 10),
                    weighted(Armory.gun_light_revolver, 0, 1, 1, 4),
                    weighted(ModItems.gun_kit_1, 0, 2, 3, 4),
                    weighted(Armory.ammo_standard, GunFactory.EnumAmmo.M357_FMJ.ordinal(), 1, 24, 4),
                    weighted(Armory.ammo_standard, GunFactory.EnumAmmo.G40_HE.ordinal(), 1, 6, 3),
                    weighted(Armory.ammo_standard, GunFactory.EnumAmmo.G26_FLARE_WEAPON.ordinal(), 1, 1, 5),
                    weighted(ModItems.rod, ItemBreedingRod.BreedingRodType.U235.ordinal(), 1, 1, 2),
                    weighted(Billets.billet_uranium_fuel, 0, 1, 1, 2),
                    weighted(Ingots.ingot_uranium_fuel, 0, 1, 1, 2),
                    weighted(Foods.bottle_nuka, 0, 1, 3, 6),
                    weighted(Foods.bottle_quantum, 0, 1, 1, 3),
                    weighted(ModItems.stealth_boy, 0, 1, 1, 7),
                    weighted(ModItems.gas_mask_m65, 0, 1, 1, 5),
                    weighted(ModItems.gas_mask_filter, 0, 1, 1, 5),
                    weighted(Armory.grenade_nuclear, 0, 1, 2, 2),
                    weighted(ModItems.bomb_caller, 0, 1, 1, 1),
                    weighted(ModItems.bomb_caller, 1, 1, 1, 1),
        ...
        new ItemPool(POOL_SPACESHIP) {{
            this.pool = new WeightedRandomChestContentFrom1710[] {
                    ...
                    weighted(Ingots.ingot_advanced_alloy, 0, 2, 16, 5),
                    ...
                    weighted(Powders.powder_niobium, 0, 1, 1, 1),
